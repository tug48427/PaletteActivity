...
public class CanvasFragment extends Fragment {
    ...
    */
    public static CanvasFragment newInstance (String[] colorArrEn){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enColorVals = getArguments().getStringArray(colorsEN);
...
*/
    ...
    */
    ...
    public void updateCanFrag(int postion){
      //String color = enColorVals[postion];
        int colorTo = Color.parseColor(enColorVals[postion]);
        getView().setBackgroundColor(colorTo);
